...
export const cryptoProcessorEnum = pgEnum('crypto_processor', [
  'bitpay',
  'binance_pay',
  'bybit',
  'kucoin',
...
export const botExecutionStatusEnum = pgEnum('bot_execution_status', [
  'pending',
  'running',
  'completed',
  'failed',
...
export const forumMemberRoleEnum = pgEnum('forum_member_role', [
  'owner',
  'admin',
  'moderator',
  'member',
...
export const autoPatchStatusEnum = pgEnum('auto_patch_status', [
  'analyzing',
  'generating_patch',
  'applying_patch',
  'rebuilding',
...
export const jesusCartelStreams = pgTable('jesus_cartel_streams', {
  ...
  releaseId: varchar('release_id')
    .references(() => jesusCartelReleases.id)
    .notNull(),
...
export const p2pOfferStatusEnum = pgEnum('p2p_offer_status', [
  'active',
  'paused',
  'completed',
  'cancelled',
...
export const p2pDisputeStatusEnum = pgEnum('p2p_dispute_status', [
  'open',
  'reviewing',
  'resolved',
  'escalated',
...
export const walletConnectSessionStatusEnum = pgEnum('wallet_connect_session_status', [
  'active',
  'expired',
  'disconnected',
]);
...
export const mixingStatusEnum = pgEnum('mixing_status', [
  'pending',
  'mixing',
  'completed',
  'failed',
...
export const metalTradeStatusEnum = pgEnum('metal_trade_status', [
  'pending',
  'confirmed',
  'shipped',
  'delivered',
...
export const ownershipLocationEnum = pgEnum('ownership_location', [
  'vault',
  'delivery_pending',
  'delivered',
]);
...
export const userWidgetPreferences = pgTable(
...
export const etherealOwnership = pgTable(
  'ethereal_ownership',
  {
    id: varchar('id')
      .primaryKey()
...
export const botListingStatusEnum = pgEnum('bot_listing_status', [
  'active',
  'paused',
  'sold_out',
  'inactive',
...
export const brokerAccountStatusEnum = pgEnum('broker_account_status', [
  'active',
  'inactive',
  'suspended',
...
export const brokerOrderTypeEnum = pgEnum('broker_order_type', [
  'market',
  'limit',
  'stop',
  'stop_limit',
...
export const brokerOrderStatusEnum = pgEnum('broker_order_status', [
  'pending',
  'submitted',
  'filled',
  'partially_filled',
...
export const brokerOrderTimeInForceEnum = pgEnum('broker_order_time_in_force', [
  'day',
  'gtc',
  'ioc',
  'fok',
...
export const fanFollows = pgTable(
  'fan_follows',
  {
    ...
    fanId: varchar('fan_id')
      .references(() => users.id)
      .notNull(),
    celebrityId: varchar('celebrity_id')
...
export const financialAssetTypeEnum = pgEnum('financial_asset_type', [
  'stock',
  'forex',
  'bond',
  'retirement_401k',
...
export const financialOrderStatusEnum = pgEnum('financial_order_status', [
  'pending',
  'executed',
  'cancelled',
  'failed',
...
export const financialHoldings = pgTable(
  'financial_holdings',
  {
    id: varchar('id')
      .primaryKey()
