...
export default function RetirementPage() {
  ...
  return (
    <div className="container mx-auto p-6 space-y-6 cyber-bg text-white">
      <div className="flex items-center justify-between">
        ...
        <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
          <DialogTrigger asChild>
            <Button data-testid="button-contribute" className="cyber-button">
          ...
          <DialogContent className="cyber-card">
            ...
            <Form {...form}>
              <form
                onSubmit={form.handleSubmit((data) => createContributionMutation.mutate(data))}
                className="space-y-4"
              >
                <FormField
      ...
      <div className="grid gap-4 md:grid-cols-4">
        <Card className="cyber-card cyber-glow-cyan">
        ...
        <Card className="cyber-card cyber-glow-green">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
        ...
        <Card className="cyber-card cyber-glow-magenta">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            ...
            <div className="space-y-3">
              {accounts.map((account) => (
                <div
                  ...
                  data-testid={`account-${account.symbol}`}
                >
                  <div>
                ...
                <div className="space-y-4">
                  {retirementOrders.map((order) => (
                    <div
                      ...
                      data-testid={`contribution-${order.id}`}
                    >
                      <div>
