...
export default function StocksPage() {
  ...
  const totalHoldingsValue =
    holdings?.reduce((sum, h) => sum + parseFloat(h.currentValue || '0'), 0) || 0;
  const totalInvested =
  ...
  const mockChartData = Array.from({ length: 30 }, (_, i) => ({
    date: `Day ${i + 1}`,
    price: stockData
      ? stockData.price + (Math.random() - 0.5) * 20
    ...
    <div className="container mx-auto p-6 space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground mt-1">Trade stocks with real-time market data</p>
        </div>
      ...
      <div className="grid gap-4 md:grid-cols-4">
        ...
        <Card>
          ...
          <CardContent>
            <div
              className={`text-2xl font-bold ${totalGainLoss >= 0 ? 'text-green-500' : 'text-red-500'}`}
          ...
          <CardContent className="space-y-4">
            ...
            {stockData && (
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  <span className="text-3xl font-bold" data-testid="text-stock-price">
                ...
                <div className="text-sm text-muted-foreground">
                  Volume: {stockData.volume.toLocaleString()} | Market Cap: $
            ...
            <CardContent>
              {holdingsLoading ? (
                ...
                <p className="text-center text-muted-foreground py-8">
                  No holdings yet. Start by placing an order!
                </p>
              )}
            </CardContent>
          </Card>
                    ...
                    .map((order) => (
                      ...
                      >
                        <div>
                          ...
                          <p className="text-sm text-muted-foreground">
                            {order.orderType.toUpperCase()} {order.quantity} @ $
